...
# docker build -t repository_quality_rails .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name repository_quality_rails repository_quality_rails
